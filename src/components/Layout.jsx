  ...
  return (
    <div style={{width:"100%",maxWidth:"100vw",overflowX:"hidden",position:"relative"}}>
      ...
      <footer>
        ...
        <div style={{marginTop:"12px"}}>Desenvolvido com <em>❤️</em> para as crianças</div>
      </footer>

      {/* INSTAGRAM */}
      <a href={CONTACT_INFO.instagram} target="_blank" rel="noreferrer" className="instagram-float" aria-label="Instagram">
